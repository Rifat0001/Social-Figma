            ...
            <div className="bg-[#00072D] pb-4 frd-bg">
                ...
                <div className="  grid justify-around grid-cols-3">
                    ...
                    <div className="text-center ">
                        ...
                        {/* tick  */}
                        <div className="verify-svg relative right-[-75px] top-[-65px]">
                            <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 22 22" fill="none">
                                <circle cx="11" cy="11" r="10.5" fill="#00072D" fill-opacity="0.91" stroke="url(#paint0_linear_146_26830)" />
                                <path d="M6.39229 17.3943L4.03465 16.8799C3.82032 16.8371 3.64886 16.7262 3.52026 16.5473C3.39166 16.369 3.34165 16.1726 3.37023 15.9583L3.60599 13.5364L1.99851 11.6931C1.85562 11.536 1.78418 11.3502 1.78418 11.1359C1.78418 10.9215 1.85562 10.7358 1.99851 10.5786L3.60599 8.73536L3.37023 6.31343C3.34165 6.0991 3.39166 5.90277 3.52026 5.72445C3.64886 5.54556 3.82032 5.43468 4.03465 5.39181L6.39229 4.87742L7.6354 2.77698C7.74971 2.59122 7.90689 2.46977 8.10693 2.41261C8.30697 2.35546 8.50701 2.3626 8.70706 2.43405L10.9361 3.3771L13.1651 2.43405C13.3652 2.3626 13.5652 2.35546 13.7653 2.41261C13.9653 2.46977 14.1225 2.59122 14.2368 2.77698L15.4799 4.87742L17.8375 5.39181C18.0519 5.43468 18.2233 5.54556 18.3519 5.72445C18.4805 5.90277 18.5305 6.0991 18.502 6.31343L18.2662 8.73536L19.8737 10.5786C20.0166 10.7358 20.088 10.9215 20.088 11.1359C20.088 11.3502 20.0166 11.536 19.8737 11.6931L18.2662 13.5364L18.502 15.9583C18.5305 16.1726 18.4805 16.369 18.3519 16.5473C18.2233 16.7262 18.0519 16.8371 17.8375 16.8799L15.4799 17.3943L14.2368 19.4948C14.1225 19.6805 13.9653 19.802 13.7653 19.8591C13.5652 19.9163 13.3652 19.9091 13.1651 19.8377L10.9361 18.8946L8.70706 19.8377C8.50701 19.9091 8.30697 19.9163 8.10693 19.8591C7.90689 19.802 7.74971 19.6805 7.6354 19.4948L6.39229 17.3943ZM9.43578 13.5792C9.59296 13.7364 9.793 13.815 10.0359 13.815C10.2788 13.815 10.4789 13.7364 10.636 13.5792L14.2796 9.93562C14.4511 9.76415 14.5368 9.56039 14.5368 9.32435C14.5368 9.08887 14.4511 8.8854 14.2796 8.71393C14.1082 8.54247 13.9047 8.45674 13.6692 8.45674C13.4332 8.45674 13.2294 8.54247 13.058 8.71393L10.0359 11.736L8.79279 10.5143C8.62132 10.3571 8.41785 10.282 8.18238 10.2888C7.94633 10.2963 7.74971 10.3786 7.59254 10.5357C7.43536 10.6929 7.35677 10.893 7.35677 11.1359C7.35677 11.3788 7.43536 11.5788 7.59254 11.736L9.43578 13.5792Z" fill="#00E7FC" />
                                <defs>
                                    <linearGradient id="paint0_linear_146_26830" x1="11" y1="0" x2="11" y2="22" gradientUnits="userSpaceOnUse">
                ...
                <div className="friend-bd mx-auto mt-6">
                    <div className="mx-5 my-2">
                        <div className="feature-outer absolute top-[505px] left-[165px] z-10 ">
                            <img src={feature} alt="" />
                        </div>
